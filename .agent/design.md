...
## Secilen Referans Tasarim
Bu projede gorsel baz olarak kullanilacak yon, kullanicinin paylastigi Claude Design ciktilaridir.

Birincil lokal referans:
[gider-hi-fi.html](C:/Users/nacho/Desktop/gider/.agent/design-reference/gider-hi-fi.html)

Destekleyici lokal referanslar:
- [gider-wireframes-standalone.html](C:/Users/nacho/Desktop/gider/.agent/design-reference/gider-wireframes-standalone.html)
- [gider-wireframes-standalone-v2.html](C:/Users/nacho/Desktop/gider/.agent/design-reference/gider-wireframes-standalone-v2.html)
- [gider-wireframes.html](C:/Users/nacho/Desktop/gider/.agent/design-reference/gider-wireframes.html)
- [claude-export-design.md](C:/Users/nacho/Desktop/gider/.agent/design-reference/claude-export-design.md)

`gider-hi-fi.html` bu proje icin `final visual source of truth` kabul edilir.
Wireframe exportlari layout ve ekran eslestirmesi icin destekleyici kaynak olarak tutulur.
Kodlama asamasinda:
- Tasarim yeniden yorumlanmayacak
- Layout yeniden icat edilmeyecek
- Kart sisteminin mantigi degistirilmeyecek
- Spacing ritmi keyfi sekilde degistirilmeyecek
- Bottom navigation, floating action button ve tek kolon mobil kurgu korunacak
- Sadece uygulamanin kendi icerigi, alanlari ve is kurallari bu gorsel sistemin icine yerlestirilecek

Kisa kural:
`Ayni tasarim dili degil, ayni tasarimin urune uyarlanmis hali.`

Bu referanstan alinacak kararlar:
- Mobil cihaz cercevesi ve tek kolon odakli ekran kurgusu korunacak
- Haftalik ozet ilk ekran olacak
- Kart tabanli bilgi hiyerarsisi korunacak
- Alt navigation + floating action button yapisi korunacak
- El yazisi / handwritten tipografi kullanilmayacak
- Hi-Fi exporttaki tipografi ve renk sistemi esas alinacak
- Renk paleti mevcut yonde kalacak ama daha canli ve daha production-ready olacak
- Wireframe hissi degil, Hi-Fi exporttaki gercek urun kalitesi hedeflenecek
...
Bu gorsel yon artik sadece soyut bir yonlendirme degil; lokal exporttaki ekranlar birebir baz alinacak. Uygulamaya ozel uyarlama yapilacak yerler:
- metinler ve veri alanlari
- reserve planner bolumu
- gelir/gider form alanlari
- recurring gider aksiyonlari

Bunlar disinda gorsel kompozisyonun ana mantigi korunacak.
...
## Sonraki Adim
Bu dokuman artik tasarim varyanti uretmek icin degil, secilmis final referansi uygulamaya dogru tasimak icin kullanilacak. Kodlama sirasinda lokal export esas alinacak; implementation plan ve UI handoff bu referansa gore yurutulecek.
