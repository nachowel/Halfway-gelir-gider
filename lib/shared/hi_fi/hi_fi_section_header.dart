...
class HiFiSectionHeader extends StatelessWidget {
  const HiFiSectionHeader.title({required this.left, this.right, super.key})
    : _eyebrow = false;

  const HiFiSectionHeader.eye({required this.left, this.right, super.key})
    : _eyebrow = true;
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: <Widget>[
        ...
        if (right != null) Text(right!.toUpperCase(), style: AppTypography.eye),
      ],
    );
  }
}
